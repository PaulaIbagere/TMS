	...
	<tr>
		...
		<tr>
			<td align="center" colspan="2">
				<input type="submit" value="Keep" name="B1" tabindex="3" style="color: #FFFFFF; font-size: 14pt; font-family: Traditional Arabic; font-weight: bold; background-color: #5A74A0"></td>
		</tr>
	</table>
	</form>
	</div>
