		 ...
		 <div align="center">
			<table border="0" width="100%" id="table1" height="219">
			   <tr>
				  <td height="55">
				  <div align="center">
				  <table border="2" width="99%" bordercolorlight="#003366" bordercolordark="#003366" id="table2" bordercolor="#003366" cellpadding="5" cellspacing="5">
					<tr>
					  ...
					  <?php
					  	...
					  	?>
			 					<font face="Traditional Arabic" color="#B0CCFF" size="3">
									<a href="CollegeManage.php?AcadDeg=<?php echo($row3[1]); ?>&uncode=<?php echo($uncode1);?>&CollegeCode=<?php echo($CollegeCode1);?>&Dept=<?php echo($row3[2]); ?>#AcadDeg">
								<b>
								<?php
									echo($row3[0]."</br>");
								?>
